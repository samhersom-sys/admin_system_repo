...
| 2026-05-08 | Removed audit-based default mode: backend now always uses filterMode (LIMIT 2000/type). Updated §2 Recommended Approach, Potential Flaws 1 and 3. `audit_events` role updated to `lastOpenedDate` field only. |
