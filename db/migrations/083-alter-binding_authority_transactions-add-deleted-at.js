...
async function run() {
    ...
    try {
        // 083: Add soft-delete column to binding_authority_transactions (§15.8 compliance)
        ...
        console.log('[083] Done.')
    } finally { client.release(); await pool.end() }
}
run().catch(err => { console.error('[083] ERROR:', err.message); process.exit(1) })
