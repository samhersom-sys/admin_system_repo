'use strict'
/**
 * Schema 22: binding authority documents
 * Replaces migration: 069-create-binding-authority-documents-table
 */
...
async function run() {
    ...
    try {
        console.log('[22-documents] Creating binding_authority_documents table...')
...
run().catch(err => { console.error('[22-documents] ERROR:', err.message); process.exit(1) })
